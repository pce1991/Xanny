...
**** fifth indexing for shakespeare, the faerie queene, chaucer
     Then map these!
...
**** Remove chunks
     so close! it just doesnt seem to remove up until that point, just the first thing given...
**** Add translations
...
**** <2014-05-20 Tue>
     Something is going horribly wrong with mapping the bible it seems.
